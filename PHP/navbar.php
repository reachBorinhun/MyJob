...
<div class="navbar" id="navbarid">
    ...
    <a href=""><img  style="width: 8rem; height: auto;" id="logo" src="../Image/logo/ITJobs.png" alt="ss"></a>
    ...
    <a class="<?php echo $active5?>"  href="ContectUs.php"><i class="fa "></i> Contact us</a>
